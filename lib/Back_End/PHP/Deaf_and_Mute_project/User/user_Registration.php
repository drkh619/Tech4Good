...
$findexist="select * from user_registration where username='".$username."'";
    ...
    $sql = "INSERT INTO user_registration (username,email,phone,password) VALUES ('".$username."','".$email."','".$phone."','".$password."')";
